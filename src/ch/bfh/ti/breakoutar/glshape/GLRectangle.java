...
public class GLRectangle implements GLShape {
	...
	/**
	 * Constructor of the GLRectangle class
	 * @param textureName: The name of the texture as a String
	 * @param x: The size of the edges in x direction
	 * @param y: The size of the edges in y direction
	 * @param z: The size of the edges in z direction
	 * @param assets: The AssetManager gives us a link to the texture
	 */
	public GLRectangle(String textureName, float x, float y, float z, AssetManager assets) {
		this.assets = assets;
	...
	public void setTextureName(String textureName) {
		...
		try {
			...
			Log.d("Texture", "couldn't load asset Rectangle-Texture!");
		}
	}
	...
	/**
	 * Loads a texture belonging to the GLRectangle
	 * @param gl Object
	 */
